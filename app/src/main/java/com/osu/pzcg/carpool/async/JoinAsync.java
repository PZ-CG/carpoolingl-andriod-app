 ...
 */
public class JoinAsync extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            String link = "http://pzcg.biz/join_carpool.php?initiator_name="+ URLEncoder.encode(username)+"&time="+URLEncoder.encode(time)+
